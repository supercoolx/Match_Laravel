...
MySQL - 10.4.21-MariaDB : Database - match
*********************************************************************
*/
...
/*Data for the table `favourite_project` */
...
insert  into `history_types`(`id`,`description`) values 
(1,'register'),
(2,'login'),
(3,'logout'),
(4,'create project'),
...
CREATE TABLE `reviews` (
  ...
  `description` varchar(127) NOT NULL,
  `require` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4;

/*Data for the table `reviews` */

insert  into `reviews`(`id`,`type`,`level`,`description`,`require`) values 
(1,1,1,'はじめの一歩',1),
(2,1,2,'案件コレクター！',5),
(3,1,3,'次世代のエース',10),
(4,1,4,'営業のスペシャリスト',15),
(5,1,5,'華麗なるトップエージェント',30),
(6,1,6,'ゴゴレルマスター',50),
(7,2,1,'はじめての閲覧者',1),
(8,2,2,'注目の的！',10),
(9,2,3,'次世代のスーパースター',30),
(10,2,4,'広報のスペシャリスト',50),
(11,2,5,'生来のトップエージェント',100),
(12,2,6,'ゴゴレルマスター',300),
(13,3,1,'はじめての契約',1),
(14,3,2,'エージェントの鏡！',3),
(15,3,3,'次世代の救世主',5),
(16,3,4,'マッチングスペシャリスト',10),
(17,3,5,'伝説のトップエージェント',15),
(18,3,6,'ゴゴレルマスター',30),
(19,4,1,'はじめてのフォロー',1),
(20,4,2,'フォロー大好き！',10),
(21,4,3,'次世代のナンパ師',30),
(22,4,4,'口説きのスペシャリスト',50),
(23,4,5,'有名なトップエージェント',100),
(24,4,6,'ゴゴレルマスター',300),
(25,5,1,'はじめてのフォロワー',1),
(26,5,2,'モテ期到来！',10),
(27,5,3,'次世代のインフルエンサー',30),
(28,5,4,'モテのスペシャリスト',50),
(29,5,5,'魅惑のトップエージェント',100),
(30,5,6,'ゴゴレルマスター',300),
(31,6,1,'はじめてのトモダチ',1),
(32,6,2,'みんなトモダチ！',3),
(33,6,3,'次世代のパリピ',5),
(34,6,4,'友達作りのスペシャリスト',10),
(35,6,5,'みんなのトップエージェント',15),
(36,6,6,'ゴゴレルマスター',30);
