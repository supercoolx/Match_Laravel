                    ...
                    @foreach($projects as $project)
                        <div class="col-md-12 project-item">
                            ...
                            <div class="d-flex justify-content-center content-actions">
                                <a href="{{ route('agent.project.detail', ['id' => $project->id]) }}" class="btn btn-theme btn-small btn-blue-light d-flex align-items-center justify-content-center">詳細</a>
                                <a href="{{ route('agent.project.edit', ['id' => $project->id]) }}" class="btn btn-theme btn-small btn-blue d-flex align-items-center justify-content-center">編集</a>
            ...
            <div class="container">
                <div class="content-no-posted">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('agent.project.create') }}" class="btn btn-theme btn-medium d-flex justify-content-center align-items-center">案件を掲載する</a>
                    </div>
                </div>
            </div>
        </section>
