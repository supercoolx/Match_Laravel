        ...
        <div class="container">
            <div class="d-flex justify-content-center">
                <div class="blog-content">
                    ...
                    <p>2.ユーザーが利用料金の支払を遅滞した場合には，ユーザーは後日必ず利用料金分を支払うものとします。</p>
                    <br>
                    <h3>第5条（禁止事項）</h3>
                    <p class="abstract">ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</p>
                    ...
                    <p>12.当社のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為</p>
                    ...
                    <br>
                    <h3>第8条（解約）</h3>
                    <p>ユーザーは，当社の定める解約手続により，本サービスから解約できるものとします。</p>
                    <br>
